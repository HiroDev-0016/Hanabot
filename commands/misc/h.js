...
.setDescription(`
<:hana_arrow:729074687145017435> slowmode - Ative o modo lento no canal onde o comando foi executado! \`ht!slowmode (número) [Motivo]\`
...
<:hana_arrow:729074687145017435> addemoji - Adicione um emoji da sua lista de emojis
...
.setThumbnail(`${message.member.user.displayAvatarURL({dynamic: true})}`)
.setDescription(`
<:hana_arrow:729074687145017435> background - Compre backgrounds para seu perfil usando HanaCoins!
<:hana_arrow:729074687145017435> layouts - Compre um layout para seu perfil usando HanaCoins!
...
.setThumbnail(`${message.member.user.displayAvatarURL()}`)
.setDescription(`1️⃣  Comandos de música
2️⃣  Comandos diversos
3️⃣  Para começar
4️⃣  Comandos de diversão 
5️⃣  Hana Premium
6️⃣  Comandos de moderação
...
coletor.on("collect", cp => {
     msg.edit(embedmisc)
       ...
       let filtro233 = (reaction, usuario) => reaction.emoji.name === "6️⃣" && usuario.id === message.author.id;
...
coletor233.on("collect", cp => {
     msg.edit(modembed)
        ...
        let filtro12 = (reaction, usuario) => reaction.emoji.name === "5️⃣" && usuario.id === message.author.id;
...
coletor3.on("collect", cp => {
  msg.edit(getstarted)
   ...
   let filtro5 = (reaction, usuario) => reaction.emoji.name === "4️⃣" && usuario.id === message.author.id
...
.setDescription(`
<:hana_arrow:729074687145017435> slowmode - Set slowmode into the channel you used the command! \`ht!slowmode (Number) [Reason]\`
...
.setThumbnail(`${message.member.user.displayAvatarURL({dynamic: true})}`)
.setDescription(`
<:hana_arrow:729074687145017435> background - Buy a background to your profile using HanaCoins!
<:hana_arrow:729074687145017435> **[Premium Only]** setback - Set a customized background to your profile!
<:hana_arrow:729074687145017435> layout - Buy a layout to your profile using HanaCoins!
...
.setTitle('Commands')
.setThumbnail(`${message.member.user.displayAvatarURL()}`)
.setDescription(`1️⃣  Hana music Commands
2️⃣  Miscellaneous Commands
3️⃣  Get Started
4️⃣  Fun commands! 
5️⃣  Hana Vip 
